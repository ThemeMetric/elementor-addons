...
use Elementor_tp_feature_Control;
use Elementor_Currency_Widget;
use Elementor_Feature_Widget;
...
final class Plugin {
	...
	public function add_category( $elements_manager ) {
		...
		$elements_manager->add_category(
			'noxia-category',
			[
				'title' => esc_html__( 'Noxia Category', 'noxia' ),
				'icon' => 'fa fa-plug',
			]
		);
	}
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'noxia' ),
			'<strong>' . esc_html__( 'Elementor Noxia Addon', 'noxia' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'noxia' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'noxia' ),
			'<strong>' . esc_html__( 'Elementor Noxia Addon', 'noxia' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'noxia' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'noxia' ),
			'<strong>' . esc_html__( 'Elementor Noxia Addon', 'noxia' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'noxia' ) . '</strong>',
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/tp-feature.php' );
	...
	public function register_controls( $controls_manager ) {
		...
		require_once( __DIR__ . '/controls/tp-feature-control.php' );
		//require_once( __DIR__ . '/includes/controls/control-2.php' );

		$controls_manager->register( new Elementor_Currency_Control );
		$controls_manager->register( new Elementor_tp_feature_Control );
